...
For Hellinger-based trees, the original HDDT line [CITATION: Cieslak and Chawla 2008] motivates inclusion of HDDT-style families as strong rare-event baselines in our analysis.
...
Decision-theoretic classification and utility-sensitive thresholding emphasize threshold choice under asymmetric costs [CITATION: Elkan 2001], [CITATION: Fawcett 2006]. Operational ML traditions emphasize deployment constraints, human-in-the-loop workflows, and threshold policy management in triage/review systems [CITATION: operational ML monitoring], [CITATION: human-in-the-loop triage], [CITATION: queue-aware ML deployment].
...
**Table A (v2):** Allocator family summary with threshold-survival persistence (`paper/manuscript_tables/table_allocator_family_summary_v2.md`).

To visualize whether recurring morphology labels occupy distinguishable metric regions, we then project families into smoothness-persistence space.

[Figure 6 about here]

**Figure 6:** Accessibility regime map (v2; smoothness vs threshold-survival persistence) (`paper/manuscript_figures/figure_accessibility_regime_map_v2.png`).

To probe cliff-versus-broad separation directly, we also inspect jump-persistence geometry.

[Figure 7 about here]

**Figure 7:** Accessibility regime map variant A (max jump vs threshold-survival persistence) (`paper/manuscript_figures/figure_accessibility_regime_map_variant_a_v2.png`).

To contrast endpoint recovery with persistence, we finally inspect recovery-persistence geometry.

[Figure 8 about here]

**Figure 8:** Accessibility regime map variant B (recovery vs threshold-survival persistence) (`paper/manuscript_figures/figure_accessibility_regime_map_variant_b_v2.png`).
...
Metric semantics clarification: in this manuscript, "accessibility persistence" refers to threshold-survival persistence (occupancy/reachability survival across the threshold grid), while low-score mass concentration (`<0.01`) is treated as a separate secondary descriptor. This clarification aligns metric naming with reader intuition and does not change the core empirical claims.
...
- Figure 6: `paper/manuscript_figures/figure_accessibility_regime_map_v2.png`
- Figure 7: `paper/manuscript_figures/figure_accessibility_regime_map_variant_a_v2.png`
- Figure 8: `paper/manuscript_figures/figure_accessibility_regime_map_variant_b_v2.png`
- Table 1: `paper/manuscript_tables/table_1_ranking_vs_accessibility.md`
- Table A (v2): `paper/manuscript_tables/table_allocator_family_summary_v2.md`

- [CITATION: Elkan 2001]
- [CITATION: Chawla et al. 2002]
- [CITATION: Cieslak and Chawla 2008]
- [CITATION: He and Garcia 2009]
- [CITATION: Krawczyk 2016]
- [CITATION: Davis and Goadrich 2006]
- [CITATION: Saito and Rehmsmeier 2015]
- [CITATION: Fawcett 2006]
- [CITATION: Drummond and Holte 2006]
- [CITATION: Chow 1970]
- [CITATION: El-Yaniv and Wiener 2010]
- [CITATION: Geifman and El-Yaniv 2017]
- [CITATION: Platt 1999]
- [CITATION: Zadrozny and Elkan 2002]
- [CITATION: Niculescu-Mizil and Caruana 2005]
- [CITATION: Guo et al. 2017]
